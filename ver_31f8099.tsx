      ...
      if (status === OrderStatus.PREPARING || status === OrderStatus.READY || status === OrderStatus.DELIVERED || status === OrderStatus.CANCELLED) {
        ...
        switch (status) {
          case OrderStatus.PREPARING:
            message = `${company.name}: ├ôtima not├¡cia! O Chef j├í come├ºou a preparar o seu pedido ${order.ticketCode}. Fique atento! ≡ƒæ¿ΓÇì≡ƒì│≡ƒöÑ`;
            break;
          case OrderStatus.READY:
            message = `${company.name}: O seu pedido ${order.ticketCode} est├í pronto e a cheirar maravilhosamente! Pode vir levantar agora. ≡ƒìöΓ£¿`;
            break;
          case OrderStatus.DELIVERED:
            message = `${company.name}: Pedido ${order.ticketCode} entregue! Esperamos que desfrute de cada dentada. Bom apetite! ≡ƒÿï≡ƒÖÅ`;
            break;
          case OrderStatus.CANCELLED:
            message = `${company.name}: Lamentamos imenso, mas o seu pedido ${order.ticketCode} teve de ser cancelado. Por favor, contacte o estabelecimento. ≡ƒÿö`;
            break;
        }
                        ...
                        <div className="flex justify-between items-start mb-6">
                          ...
                          <div className="text-right">
                            ...
                            <div className="flex items-center justify-end gap-1.5 mt-1 text-[#BBBBBB]">
                              ...
                              <span className="text-[10px] font-black uppercase tracking-widest leading-none">H├ü 2 MIN</span>
                            </div>
                          </div>
                        </div>
            ...
            <div className="space-y-12 animate-fade-in pb-20">
              <div className="flex justify-between items-center bg-white p-10 rounded-[3.5rem] border border-border/40 shadow-premium">
                <div>
                  ...
                  <p className="text-text-muted font-medium mt-1">Vis├úo geral do faturamento e opera├º├╡es.</p>
                </div>
                <div className="flex gap-4">
                  <button
              ...
              <div className="hidden print:flex justify-between items-center border-b-4 border-primary pb-8 mb-12">
                <div>
                  <h1 className="text-4xl font-black text-secondary uppercase tracking-tighter">Relat├│rio de Desempenho</h1>
                  <p className="text-xl font-bold text-primary mt-2">{company.name}</p>
                </div>
                <div className="text-right">
                  <p className="text-sm font-black text-secondary uppercase tracking-widest">Extra├¡do em:</p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="bg-white p-10 rounded-[3.5rem] border border-secondary shadow-premium group hover:border-primary/20 transition-all">
                  <p className="text-[11px] font-black text-text-muted uppercase tracking-[0.3em] mb-4">Faturamento L├¡quido</p>
                  <div className="flex items-baseline gap-3">
              ...
              <div className="bg-surface rounded-[4rem] shadow-premium border border-white/60 overflow-hidden">
                <div className="p-12 border-b border-border/40 bg-white/50">
                  <h4 className="text-2xl font-black text-secondary uppercase tracking-tighter">Hist├│rico Detalhado para Auditoria</h4>
                </div>
        ...
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-8 bg-secondary/80 backdrop-blur-3xl animate-in fade-in duration-500">
          <div className="bg-surface rounded-[4.5rem] w-full max-w-2xl shadow-premium p-16 animate-in zoom-in-95 duration-300 relative overflow-hidden">
            ...
            <form onSubmit={handleSaveProduct} className="space-y-10">
              <div className="space-y-3">
                <label className="text-[11px] font-black text-secondary uppercase tracking-[0.4em] ml-2 opacity-40">Identifica├º├úo do Item</label>
              ...
              <div className="grid grid-cols-2 gap-8">
                ...
                <div className="space-y-3">
                  <label className="text-[11px] font-black text-secondary uppercase tracking-[0.4em] ml-2 opacity-40">Sess├úo do Menu</label>
